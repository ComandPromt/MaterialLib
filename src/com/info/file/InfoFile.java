...
public class InfoFile extends javax.swing.JFrame implements ActionListener, ChangeListener {
	...
	public InfoFile(List<String> lista) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(InfoFile.class.getResource("/imagenes/info.png")));
	...
	private void initComponents() {
		...
		btnNewButton_1.setIcon(new ImageIcon(InfoFile.class.getResource("/imagenes/close.png")));
		...
		btnNewButton_1_1.setIcon(new ImageIcon(InfoFile.class.getResource("/imagenes/min.png")));
		...
		copiar.setIcon(new ImageIcon(InfoFile.class.getResource("/imagenes/copy.png")));
		...
		abrir.setIcon(new ImageIcon(InfoFile.class.getResource("/imagenes/abrir.png")));
		...
		ver.setIcon(new ImageIcon(InfoFile.class.getResource("/imagenes/view.png")));
		...
		back.setIcon(new ImageIcon(InfoFile.class.getResource("/imagenes/back.png")));
		...
		next.setIcon(new ImageIcon(InfoFile.class.getResource("/imagenes/next.png")));
		...
		btnNewButton_1_1_1.setIcon(new ImageIcon(InfoFile.class.getResource("/imagenes/move.png")));
