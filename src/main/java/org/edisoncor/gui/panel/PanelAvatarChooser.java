...
public class PanelAvatarChooser extends Panel {
	...
	private void drawAvatarBullet(Graphics2D g2, double x, double y, double bulletWidth, double bulletHeight) {
		RoundRectangle2D bullet = new RoundRectangle2D.Double(0.0, 0.0, bulletWidth, bulletHeight, bulletHeight,
				bulletHeight);
		Ellipse2D curve = new Ellipse2D.Double(-20.0, bulletHeight / 2.0, bulletWidth + 40.0, bulletHeight);

		g2.translate(x, y);

		g2.translate(-1, -2);
		g2.setColor(new Color(0, 0, 0, 170));
		g2.fill(new RoundRectangle2D.Double(0.0, 0.0, bulletWidth + 2, bulletHeight + 4, bulletHeight + 4,
				bulletHeight + 4));
		g2.translate(1, 2);
	...
	private void promoteAvatarToDrawable(List<DrawableAvatar> drawables, int x, int y, int width, int height,
		...
		drawables.add(new DrawableAvatar(avatarIndex + offset, avatar_x, avatar_y, newWidth, newHeight, avatarPosicion,
				result));
	}
	...
	private List<Avatar> getSampleAvatar() {
		...
		avatares.add(new Avatar("Imagen 1", loadImage("/resources/task-view-photos.png")));
		avatares.add(new Avatar("Imagen 2", loadImage("/resources/task-logout.png")));
		avatares.add(new Avatar("Imagen 3", loadImage("/resources/task-create-trip.png")));
		avatares.add(new Avatar("Imagen 4", loadImage("/resources/shinybuttoncenterinv.png")));
		avatares.add(new Avatar("Imagen 5", loadImage("/resources/task-logout.png")));
		avatares.add(new Avatar("Imagen 6", loadImage("/resources/shinybutton.png")));
		avatares.add(new Avatar("Imagen 7", loadImage("/resources/task-create-trip.png")));
		return avatares;
	}
	...
	private class AvatarScroller extends MouseAdapter {
		...
		public void mouseClicked(MouseEvent e) {
			...
			if ((faderTimer != null && faderTimer.isRunning()) || (scrollerTimer != null && scrollerTimer.isRunning())
			...
			if (avatar != null && e.getButton() == MouseEvent.BUTTON1) {
