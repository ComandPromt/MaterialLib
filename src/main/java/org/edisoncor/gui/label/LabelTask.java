...
public class LabelTask extends JLabel {
	...
	public LabelTask(String name) {
		...
		ponerImagen(this.getClass().getResource("/resources/header-halo.png").toString());
	...
	private void ponerImagen(String imagen) {

		imagen = imagen.replace("file:/", "");
