...
public class ButtonAqua extends JButton {
	...
	protected Paint gradiente1() {
		LinearGradientPaint gr = new LinearGradientPaint(0, 0, 0, getHeight(), new float[] { 0f, 1f },
				new Color[] { getBackground().darker(), getBackground().brighter() });
		return gr;
	}

	private Paint gradiente2() {
		LinearGradientPaint gr = new LinearGradientPaint(0, 0, 0, getHeight(), new float[] { 0f, .5f, 1f },
