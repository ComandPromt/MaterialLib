...
public class ButtonShadow extends JButton {
	...
	protected void paintComponent(Graphics g) {
		...
		if (getIcon() != null) {
			...
			BufferedImage shadow = factory
					.createShadow(GraphicsUtil.toBufferedImage(((ImageIcon) getIcon()).getImage()));
			g2.drawImage(shadow, (getWidth() / 2) - (shadow.getWidth() / 2),
					(getHeight() / 2) - (shadow.getHeight() / 2), shadow.getWidth(), shadow.getHeight(), null);
		}
