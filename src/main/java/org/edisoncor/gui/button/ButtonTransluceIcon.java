...
public class ButtonTransluceIcon extends JButton {
	...
	public ButtonTransluceIcon(String text) {
		setText(text);
		setOpaque(false);
	...
	protected void paintComponent(Graphics g) {
		...
		RoundRectangle2D.Float r2d = new RoundRectangle2D.Float(0, 0, getWidth(), getHeight(), getHeight() / 3,
				getHeight() / 3);
		g2.clip(r2d);

		ButtonModel modelo = getModel();

		RoundRectangle2D rect = new RoundRectangle2D.Double(0, 0, getWidth(), getHeight(), getHeight() / 3,
				getHeight() / 3);
