...
public class TitleBar extends JPanel {
	...
	private static final Icon CLOSE_ICON = new ImageIcon(TitleBar.class.getResource("/resources/button-close-16.png"));

	private static final Icon CLOSE_HOVER_ICON = new ImageIcon(
			TitleBar.class.getResource("/resources/button-close-over-16.png"));

	private static final Icon CLOSE_PRESSED_ICON = new ImageIcon(
			TitleBar.class.getResource("/resources/button-close-pressed-16.png"));
	...
	protected void paintComponent(Graphics g) {
		...
		Area titleArea = new Area(new Area(new RoundRectangle2D.Double(0, 0, getWidth(), getHeight(), 16, 16)));
