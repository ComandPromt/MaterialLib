...
public class ElevationEffectRectangle {
	...
	private ElevationEffectRectangle(JComponent component, int level) {
	...
	public void paint(Graphics g) {
		...
		g.drawImage(MaterialShadowRectangle.renderShadow(this.target.getWidth(), this.target.getHeight(),
	...
	public static class Circular extends ElevationEffectRectangle {
		...
		public void paint(Graphics g) {
			...
			g.drawImage(MaterialShadowRectangle.renderCircularShadow(this.target.getWidth(),
					((Double) this.level.getValue()).doubleValue()), 0, 0, null);
