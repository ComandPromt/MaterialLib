...
public class ToggleButton extends JComponent {
	...
	private Color circleColorDisabled;

	private Color circleColorEnabled;

	private final Insets shadowSize;

	private final List<ToggleListener> events;

	public void setColors(Color circle, Color background) {

		setForeground(background);

		setCircleColorEnabled(circle);

		setCircleColorDisabled(circle);
	...
	public void setCircleColorEnabled(Color circleColorEnabled) {

		this.circleColorEnabled = circleColorEnabled;
	...
	public void setCircleColorDisabled(Color circleColor) {

		this.circleColorDisabled = circleColor;
	...
	public ToggleButton(String text) {
		...
		circleColorDisabled = Color.WHITE;

		circleColorEnabled = Color.WHITE;
