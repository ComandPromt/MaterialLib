...
public class MessageDialog extends javax.swing.JDialog {
	...
	private com.dialog.confirm.Background background1;
	...
	public MessageDialog(JFrame fram, String title, String message) {
	...
	private void initComponents() {
		...
		background1 = new com.dialog.confirm.Background();
		...
		cmdCancel.setFont(new java.awt.Font("Dialog", 0, 20));
		...
		cmdOK.setFont(new java.awt.Font("Dialog", 0, 20));
		...
		lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/imagenes/icon.png")));
