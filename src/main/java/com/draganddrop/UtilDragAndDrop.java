...
public class UtilDragAndDrop {

	private java.awt.dnd.DropTargetListener dropListener;

	public UtilDragAndDrop(final java.awt.Component c, final javax.swing.border.Border dragBorder,
			final boolean recursive, final Listener listener) throws TooManyListenersException {
