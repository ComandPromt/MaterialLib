...
public final class Reflection {
	...
	private static BufferedImage createReflection(BufferedImage avatar, int avatarWidth, int avatarHeight) {
		...
		BufferedImage buffer = new BufferedImage(avatarWidth, avatarHeight * 5 / 3, BufferedImage.TYPE_INT_ARGB);
	...
	public static BufferedImage createGradientMask(int avatarWidth, int avatarHeight, float opacityStart,
			float opacityEnd) {
		...
		GradientPaint painter = new GradientPaint(0.0f, 0.0f, new Color(1.0f, 1.0f, 1.0f, opacityStart), 0.0f,
				avatarHeight / 2.0f, new Color(1.0f, 1.0f, 1.0f, opacityEnd));
