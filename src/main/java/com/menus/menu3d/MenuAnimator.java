...
public class MenuAnimator {
	...
	private void startAnimation(boolean show) {
		...
		if (show) {
			...
			targetColor1 = new PropertySetter(item, "background", item.getBackground(),
					item.getDefaultBackgroundSelected());

			targetColor2 = new PropertySetter(item, "colorShadowTop", item.getBackground(),
					item.getDefaultColorShadowTopSelected());

			targetColor3 = new PropertySetter(item, "colorShadowLeft", item.getBackground(),
					item.getDefaultColorShadowLeftSelected());
			...
			targetColor2 = new PropertySetter(item, "colorShadowTop", item.getBackground(),
					item.getDefaultColorShadowTop());

			targetColor3 = new PropertySetter(item, "colorShadowLeft", item.getBackground(),
					item.getDefaultColorShadowLeft());
