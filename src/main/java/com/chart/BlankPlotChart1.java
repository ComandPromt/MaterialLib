...
class BlankPlotChart1 extends JComponent {
	...
	private BlankPlotChartRender1 blankPlotChatRender;

	public BlankPlotChartRender1 getBlankPlotChatRender() {

		return blankPlotChatRender;

	}

	public void setBlankPlotChartRender(BlankPlotChartRender1 blankPlotChatRender) {
	...
	private List<Double> initGra(int size) {
