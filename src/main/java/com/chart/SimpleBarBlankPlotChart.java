...
public class SimpleBarBlankPlotChart extends JComponent {
	...
	private SimpleBarBlankPlotChatRender blankPlotChatRender;

	public SimpleBarBlankPlotChatRender getBlankPlotChatRender() {

		return blankPlotChatRender;

	}

	public void setBlankPlotChatRender(SimpleBarBlankPlotChatRender blankPlotChatRender) {
	...
	public SimpleBarBlankPlotChart() {
