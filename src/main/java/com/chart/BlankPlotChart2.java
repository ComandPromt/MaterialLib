...
class BlankPlotChart2 extends JComponent {
	...
	private BlankPlotChartRender2 blankPlotChartRender;

	public BlankPlotChartRender2 getBlankPlotChartRender() {

		return blankPlotChartRender;

	}

	public void setBlankPlotChartRender2(BlankPlotChartRender2 blankPlotChatRender2) {

		this.blankPlotChartRender = blankPlotChatRender2;
	...
	private void renderSeries(Graphics2D g2) {
		...
		if (blankPlotChartRender != null) {
			...
			blankPlotChartRender.renderGraphics(this, g2, rectangle);
	...
	private void mouseMove(Graphics2D g2, MouseEvent evt) {
		...
		if (blankPlotChartRender != null) {
			...
			blankPlotChartRender.mouseMove(rectangle, evt);
