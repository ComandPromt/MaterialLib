...
public class PasswordFieldConSombra extends JPasswordField {
	...
	public PasswordFieldConSombra(Icon icon) {
	}

	public PasswordFieldConSombra() {
		setOpaque(false);
	...
	private static Image loadImage(String fileName) {
		try {
			return ImageIO.read(PasswordFieldConSombra.class.getResource(fileName));
