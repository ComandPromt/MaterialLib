...
public class ImageSlide extends JComponent {
	...
	public void setDelay(int delay) {
		...
		animator = new Animator(delay, target);
	...
	public void showImage(int index) {
		...
		if (index < images.size() && (!animator.isRunning())) {

			imageSplit = new ImageSplit(toImage(images.get(indexOld)), getSize(),

					getAutoSize(images.get(indexOld)));
