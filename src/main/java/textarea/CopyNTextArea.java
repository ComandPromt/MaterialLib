...
class CopyNTextArea extends JTextArea {

	private CopyScroll scroll;

	public CopyNTextArea() {
	...
	private CopyScroll getScroll() {
		...
		if (scroll == null) {
			...
			scroll = (CopyScroll) view.getParent();
