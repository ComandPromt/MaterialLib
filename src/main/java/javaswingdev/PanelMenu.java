...
public class PanelMenu extends javax.swing.JComponent {
	...
	public PanelMenu(GradientDropdownMenu gradientMenu, MigLayout layout, Font font, Color foregroundColor, int index,
			String... menus) {
		...
		setLayout(new MigLayout("wrap, inset 0, fillx", "[fill]",
				"[fill, " + menuHeight + "!]0[fill, " + menuHeight + "!]"));
	...
	protected void paintComponent(Graphics grphcs) {
		...
		g2.setPaint(new GradientPaint(0, 0, gradientMenu.getGradientColor()[0], 0, height,
				gradientMenu.getGradientColor()[1]));
	...
	private void initComponents() {
		...
		layout.setHorizontalGroup(
				layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 141, Short.MAX_VALUE));
