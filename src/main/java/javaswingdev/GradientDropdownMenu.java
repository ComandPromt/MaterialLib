...
public class GradientDropdownMenu extends javax.swing.JComponent {
	...
	public void addItem(String... menus) {
		...
		if (menus.length > 0) {
			...
			PanelMenu menu = new PanelMenu(this, layout, getFont(), getForeground(), getComponentCount(), menus);
	...
	private void initComponents() {
		...
		layout.setHorizontalGroup(
				layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 639, Short.MAX_VALUE));

		layout.setVerticalGroup(
				layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 49, Short.MAX_VALUE));
